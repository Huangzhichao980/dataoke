...
class SingleValidate extends CommonValidate
{
    protected $rule = [
        ...
        'freeshipRemoteDistrict|偏远地区包邮，1-是，0-非偏远地区，不填默认所有商品freeshipRemoteDistrict' => 'in:0,1',
        'PriceCid|价格区间PriceCid'=>'length:0,10',
        'date|选择某一天的直播商品数据date'=>'dateFormat:Y-m-d',
        'sessions|场次sessions输入格式，例如02、08、12、13'=>'length:0,10',
        'subdivisionId|细分类目榜分类subdivisionId'=>'length:0,50',
        'content|包含淘口令的文本content'=>'length:0,255',
        'queryType|查询时间类型queryType'=>'in:1,2,3',
        'positionIndex|位点positionIndex'=>'length:0,50',
        'memberType|推广者角色类型memberType'=>'in:2,3',
        'tkStatus|淘客订单状态tkStatus'=>'in:12,13,14,3',
        'jumpType|跳转类型jumpType'=>'in:-1,1',
        'orderScene|场景订单场景类型orderScene'=>'in:1,2,3',
        'text|口令弹框内容text'=>'length:0,255',
        'url|口令跳转目标页url'=>'length:0,255',
        'logo|口令弹框logo'=>'length:0,255',
        'userId|生成口令的淘宝用户userId'=>'length:0,255',
        'keyWord|输入关键词keyWord搜索'=>'length:0,255',
        'goodsType|商品类型goodsType'=>'in:1,2',
        'special_id|会员运营special_id'=>'length:0,50',
        'external_id|淘宝客外部用户标记external_id'=>'length:0,50',
        'promotionSceneId|联盟官方活动promotionSceneId'=>'length:0,50',
        'relationId|渠道relationId将会和传入的pid进行验证'=>'length:0,50',
        'unionId|自定义unionId输入串'=>'length:0,50',
    ];
